...
func main() {
	...
	r.Group(func(pr chi.Router) {
		...
		pr.With(middleware.RequireRole("admin", "guest")).Mount("/api/pet", pet.Routes(appDB, cfg.OpencodeAPIKey, cfg.OpencodeModel, cfg.ElevenLabsAPIKey, cfg.ElevenLabsVoiceID, photoStorage))
